...
export interface HomeContent {
  ...
  init4Title: string;
  init4BodyPre: string;
  init4BodyPost: string;
  init4Citation: string;
...
export const homeContent: Record<Locale, HomeContent> = {
  en: {
    ...
    init4BodyPre: "Advising CPOs, eMSPs, and fleet operators on monetisation and business-model strategy — grounded in established frameworks for how business models actually develop and change",
    init4BodyPost: " — plus hands-on facilitation: introductions, coalition-building, roaming agreements, multi-operator corridors, and cross-border trade-route collaboration with regional economic communities.",
    init4Citation: "Christensen, Bartman & van Bever, \"The Hard Truth About Business Model Innovation,\" Harvard Business School / MIT Sloan Management Review, 2016.",
  ...
  fr: {
    ...
    init4BodyPre: "Conseil aux CPO, eMSP et opérateurs de flottes sur la monétisation et la stratégie de modèle économique — fondé sur des cadres établis sur la façon dont les modèles économiques se développent et évoluent réellement",
    init4BodyPost: " — ainsi qu'une facilitation concrète : mises en relation, construction de coalitions, accords d'itinérance, corridors multi-opérateurs, et collaboration sur les routes commerciales transfrontalières avec les communautés économiques régionales.",
    init4Citation: "Christensen, Bartman et van Bever, « The Hard Truth About Business Model Innovation », Harvard Business School / MIT Sloan Management Review, 2016.",
  ...
  rw: {
    ...
    init4BodyPre: "Gutanga inama ku ba CPO, eMSP, n'abakoresha amakipe y'imodoka ku bijyanye no kwinjiza amafaranga n'uburyo bw'ubucuruzi — bishingiye ku miterere yemejwe y'uko ubucuruzi butera imbere kandi buhinduka mu by'ukuri",
    init4BodyPost: " — hiyongereyeho ubwunganizi nyabwo: guhuza abantu, kubaka amasezerano, amasezerano y'imikoranire, imihanda ihuza ibigo byinshi, n'imikoranire mu bucuruzi hakurikijwe imipaka hamwe n'imiryango y'ubukungu y'akarere.",
    init4Citation: "Christensen, Bartman na van Bever, \"The Hard Truth About Business Model Innovation,\" Harvard Business School / MIT Sloan Management Review, 2016.",
  ...
  sv: {
    ...
    init4BodyPre: "Rådgivning till CPO:er, eMSP:er och flottoperatörer om monetisering och affärsmodellsstrategi — grundad i etablerade ramverk för hur affärsmodeller faktiskt utvecklas och förändras",
    init4BodyPost: " — samt praktisk facilitering: kontaktförmedling, koalitionsbyggande, roamingavtal, korridorer med flera operatörer, och gränsöverskridande handelsvägssamarbete med regionala ekonomiska gemenskaper.",
    init4Citation: "Christensen, Bartman & van Bever, \"The Hard Truth About Business Model Innovation\", Harvard Business School / MIT Sloan Management Review, 2016.",
