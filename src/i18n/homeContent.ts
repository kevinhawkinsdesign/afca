...
export const homeContent: Record<Locale, HomeContent> = {
  en: {
    ...
    missionBody: "Cross-border and cross-city corridors — Mombasa to Nairobi, Kigali to Nairobi — don't follow operator boundaries. A driver on one of these routes shouldn't need three apps and three accounts to complete a single journey. AfCA is the apolitical, vendor-neutral body bringing Charge Point Operators, Electromobility Service Providers, utilities, fleet operators, hardware OEMs, and policymakers together to build that interoperability through open standards and collaborative leadership — not by favouring any one company or technology.",
    ...
    founder2Blurb: "Built roaming products from zero at Monta and has contributed directly to the OCPI protocol.",
    ...
    explore2Body: "Country-by-country market mapping and the Pan-African Interoperability and Reliability Index. Every figure carries a source; superseded reports stay published, not deleted.",
  ...
  fr: {
    ...
    missionBody: "Les corridors transfrontaliers et interurbains — Mombasa-Nairobi, Kigali-Nairobi — ne suivent pas les frontières des opérateurs. Un conducteur sur l'un de ces trajets ne devrait pas avoir besoin de trois applications et trois comptes pour un seul voyage. AfCA est l'organisme apolitique et neutre vis-à-vis des fournisseurs qui réunit Charge Point Operators, Electromobility Service Providers, distributeurs d'électricité, opérateurs de flottes, fabricants de matériel et décideurs publics pour construire cette interopérabilité par des standards ouverts et un leadership collaboratif — sans favoriser une entreprise ou une technologie en particulier.",
    ...
    founder2Blurb: "A construit des produits d'itinérance depuis zéro chez Monta et a contribué directement au protocole OCPI.",
    ...
    explore2Title: "Intelligence",
    explore2Body: "Cartographie du marché pays par pays et Pan-African Interoperability and Reliability Index. Chaque chiffre est sourcé ; les rapports remplacés restent publiés, jamais supprimés.",
  ...
  rw: {
    ...
    founder2Blurb: "Yubatse ibicuruzwa by'imikoranire uhereye ku busa kuri Monta kandi yagize uruhare rudasubirwaho mu iterambere ry'ikoranabuhanga OCPI.",
    ...
    explore2Body: "Igereranya ry'isoko rya buri gihugu na Pan-African Interoperability and Reliability Index. Buri mubare ufite isoko ryawo; raporo zasimbuwe zigumana gusohoka, ntizisibwa.",
  ...
  sv: {
    ...
    heroP2: "Som en opolitisk sanningskälla överbryggar AfCA klyftan mellan offentlig politik och teknisk implementering på plats. Vi samlar Charge Point Operators, Electromobility Service Providers, elbolag, flottoperatörer, hårdvarutillverkare och beslutsfattare för att bygga en enhetlig, hållbar laddmarknad.",
    scroll: "Skrolla",
    ...
    missionBody: "Gränsöverskridande och interurbana korridorer — Mombasa till Nairobi, Kigali till Nairobi — följer inte operatörsgränser. En förare på en av dessa sträckor ska inte behöva tre appar och tre konton för att slutföra en enda resa. AfCA är det opolitiska, leverantörsneutrala organ som samlar Charge Point Operators, Electromobility Service Providers, elbolag, flottoperatörer, hårdvarutillverkare och beslutsfattare för att bygga den interoperabiliteten genom öppna standarder och gemensamt ledarskap — utan att gynna ett enskilt företag eller en enskild teknik.",
    ...
    founder2Blurb: "Byggde roamingprodukter från grunden på Monta och har bidragit direkt till OCPI-protokollet.",
    ...
    explore2Body: "Landsvis marknadskartläggning och Pan-African Interoperability and Reliability Index. Varje siffra har en källa; ersatta rapporter förblir publicerade, de tas aldrig bort.",
