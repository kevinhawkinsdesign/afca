...
export const glossaryTerms: Record<Locale, Array<[string, string]>> = {
  ...
  fr: [
    ...
    ["eMSP", "E-Mobility Service Provider (aussi écrit EMSP) — vend l'accès à la recharge aux conducteurs, souvent sur plusieurs réseaux de CPO via des accords d'itinérance."],
  ...
  rw: [
    ...
    ["eMSP", "E-Mobility Service Provider (byanditswe kandi EMSP) — igurisha uburenganzira bwo gucyuza ku bashoferi, akenshi ku miyoboro myinshi ya CPO binyuze mu masezerano y'imikoranire."],
  ...
  sv: [
    ...
    ["eMSP", "E-Mobility Service Provider (skrivs även EMSP) — säljer laddåtkomst till förare, ofta över flera CPO-nätverk genom roamingavtal."],
