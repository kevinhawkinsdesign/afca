...
export const aboutContent: Record<Locale, AboutContent> = {
  en: {
    ...
    founder2Bio: "Puya has built roaming products from the ground up, scaling Monta's CPO network from zero and expanding its app offer to include over one million chargers across Europe and North America. He has been a contributor to the OCPI protocol and has advised CPOs, eMSPs, and national agencies across Europe, Africa, and Latin America on OCPI integrations, CDR reconciliation, and AFIR National Access Point compliance. He has also worked in operations and legal roles at technology companies and startups, giving him a broad understanding of how to bridge strategy, structure, and execution.",
  ...
  fr: {
    ...
    founder2Bio: "Puya a construit des produits d'itinérance depuis zéro, faisant grandir le réseau de CPO de Monta à partir de rien jusqu'à couvrir plus d'un million de bornes en Europe et en Amérique du Nord. Il a contribué au protocole OCPI et a conseillé des CPO, des eMSP et des agences nationales en Europe, en Afrique et en Amérique latine sur les intégrations OCPI, le rapprochement des CDR et la conformité au Point d'Accès National (NAP) du règlement AFIR. Il a également occupé des fonctions opérationnelles et juridiques dans des entreprises technologiques et des startups, ce qui lui donne une compréhension large de la manière d'articuler stratégie, structure et exécution.",
  ...
  rw: {
    ...
    founder2Bio: "Puya yubatse ibicuruzwa by'imikoranire uhereye ku busa, agaza urusobe rwa CPO rwa Monta guhera ku busa kugera ku burenganzira ku bicuruzwa birenga miliyoni imwe muri Uburayi na Amerika y'Amajyaruguru. Yagize uruhare mu iterambere ry'ikoranabuhanga OCPI kandi yagiriye inama CPO, eMSP, n'ibigo bya Leta muri Uburayi, Afurika, na Amerika y'Epfo ku bijyanye n'imikoranire ya OCPI, iyunganira rya CDR, no kubahiriza AFIR National Access Point. Yakoze kandi imirimo y'imicungire n'iy'amategeko mu masosiyete y'ikoranabuhanga n'ibigo bitangira, bimuha ubumenyi bwimbitse ku guhuza ingamba, imiterere, n'ishyirwa mu bikorwa.",
  ...
  sv: {
    ...
    founder2Bio: "Puya har byggt roamingprodukter från grunden och skalat Montas CPO-nätverk från noll till att omfatta över en miljon laddare i Europa och Nordamerika. Han har bidragit till OCPI-protokollet och har rådgivit CPO:er, eMSP:er och nationella myndigheter i Europa, Afrika och Latinamerika om OCPI-integrationer, CDR-avstämning och efterlevnad av AFIR:s National Access Point. Han har även arbetat med drift- och juridikfrågor på teknikföretag och startups, vilket gett honom en bred förståelse för hur strategi, struktur och genomförande hänger ihop.",
